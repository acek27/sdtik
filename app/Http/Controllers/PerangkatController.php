...
class PerangkatController extends Controller
{
    ...
    public function index()
    {
        ...
        ,'tb_ram.ukuran_ram','tb_ram.keterangan','tb_hdd.ukuran_hdd','tb_hdd.keterangan','tb_hdd.keterangan','tb_rak.nomer_rak','tb_core.jumlah_core')
        ->where('tb_perangkat.id_perangkat');
