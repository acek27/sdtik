...
@section('css')
  ...
  <link href="{{url('https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/css/bootstrap-datepicker.css')}}" rel="stylesheet">
...
@section('content')
    ...
    <label class="input-group-addon btn" for="testdate">
       <span class="fa fa-calendar"></span>
								...
								<div class="form-group" style="margin-top: 0px">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="no_rekening" type="text" class="form-control" id="no_rekening"
							...
							<div class="form-group" style="margin-top: 0px">
                                    <label for="dev_team" class="col-sm-3 control-label" style="font-size: 12pt">Nama Dev Team</label>

                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="dev_team" value="{{old('dev_team')}}"
	...
	left: 50%;
	margin-left: -270px;">SIMPAN</button>
                            </div>
							</br>
							</br>
                            <!-- /.box-footer -->
...
@push('script')
  ...
  <script src="{{url('https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js')}}"></script>
