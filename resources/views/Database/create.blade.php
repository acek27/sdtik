        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{route('data_base.store')}}" method="POST">
              @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="jenis_database">Jenis Database</label>
                    <input type="text" class="form-control" name="jenis_database" value="{{old('jenis_database')}}" placeholder="Jenis Database Yang DiPakai">
                    @if ($errors->any())
