...
@if ($message = Session::get('success'))
    ...
    <center>
    @if($pilihan==0)
    <a href="{{url('/seluruh_rak/cetak_pdf_seluruh')}}" class="btn btn-primary" target="_blank">CETAK PERANGKAT SELURUH</a>
    @else
    <a href="{{url('/cetak_rak/cetak_pdf_rak/{$pilihan}')}}" class="btn btn-primary" target="_blank">CETAK PERANGKAT PER RAK</a>
    @endif
    </center>
    <br>
    <br>
