        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('data_aplikasi.update',$data_aplikasi->id_aplikasi)}}"
                          method="POST">
                        {{method_field('put')}}
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_perangkat">
                                    ...
                                    @foreach ($data_perangkat as $perangkat)
                                        <option
                                            value="{{ $perangkat->id_perangkat }}" {{ $perangkat->id_perangkat == $data_aplikasi->id_perangkat ? 'selected="selected"' : '' }}> {{ $perangkat->nama_perangkat }}
                                            (Tipe : {{ $perangkat->tipe_perangkat }} & Kepemilikan
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_pengembang" class="form-control" name="id_pengembang">
                                    ...
                                    @foreach ($data_pengembang as $Pengembang )
                                        <option
                                            value="{{ $Pengembang->id_pengembang }}" {{ $Pengembang->id_pengembang == $data_aplikasi->id_pengembang ? 'selected="selected"' : '' }}> {{ $Pengembang->id_pengembang }}
                                            ( Nama Pengembang 1 : {{ $Pengembang->nama_pengembang1 }} & Nama Pengembang
                                            2 : {{ $Pengembang->nama_pengembang2 }} & Nama Pengembang
                                            3: {{ $Pengembang->nama_pengembang3 }})
                                        </option>
                            ...
                            <div class="form-group">
                                ...
                                <input name="waktu_pengembangan" type="date" class="form-control" id="datepicker"
                                       value="{{$data_aplikasi->waktu_pengembangan}}" data-date-format="DD/MMM/YYYY"
                                       required autofocus>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_database" class="form-control" name="id_database">
                                    ...
                                    @foreach ($database as $base )
                                        <option
                                            value="{{ $base->id_database }}" {{ $base->id_database == $data_aplikasi->id_database ? 'selected="selected"' : '' }}> {{ $base->jenis_database }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->any())
                            ...
                            <!--code Framework-->
                            <div class="form-group">
                                <label for="id_framework_platform">Jenis Framework Yg Dipakai & Jenis Platform Yg
                                    diHasilkan</label>
                                <select id="id_framework_platform" class="form-control" name="id_framework_platform">
                                    ...
                                    @foreach ($frame as $work )
                                        <option
                                            value="{{ $work->id_framework_platform }}" {{ $work->id_framework_platform == $data_aplikasi->id_framework_platform ? 'selected="selected"' : '' }}> {{ $work->jenis_framework }}
