...
.form-horizontal{
 ...
 <section class="content" >
				  ...
				  <div class="card card-primary">
                    ...
                    <div class="col-md-12">
                        ...
                        <!-- /.box-header -->
							...
							<form action="{{ route('homes.update',$biodata->id_tenaga) }}" class="form-horizontal" method="post">
							{{ method_field('PUT') }}
                            {{ csrf_field() }}
							@csrf                   
                            <div class="box-body">
							...
							<div class="form-group" style="margin-top: 0px">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="dev_team" value="{{$biodata->dev_team}}"
	...
	left: 50%;
	margin-left: -70px;">SIMPAN</button>
                            </div>
