...
<div class="box-body">
      ...
      <div class="row col-sm-12">
        <div class="col-lg-8"
		  ...
		  <br>
          <div>
            <h1>Inventaris Sumber Daya TIK di lingkungan Pemerintah Kabupaten Situbondo</h1>
			<br>
            <h2 style='font-size: 20px'> Sistem Informasi Ini dirancang Untuk Melakukan Pendataan Sumber Daya TIK di lingkungan Pemerintah Kabupaten Situbondo </h2>
