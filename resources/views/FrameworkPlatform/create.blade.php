            ...
            <div class="card card-primary">
              ...
              @csrf
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenis_platform" value="{{old('jenis_platform')}}" placeholder="masukan Jenis Framework Aplikasi Yang Digunakan">
                    @if ($errors->any())
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenis_framework" value="{{old('jenis_framework')}}" placeholder="masukan Jenis Framework Aplikasi Yang Digunakan">
                    @if ($errors->any())
