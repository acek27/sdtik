        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="card card-primary">
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{route('data_perangkat.update', $data_perangkat->id_perangkat)}}"
                          method="POST">
                        {{method_field('put')}}
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_perangkat"
                                       value="{{$data_perangkat->nama_perangkat}}">
                                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tipe_perangkat"
                                       value="{{$data_perangkat->tipe_perangkat}}">
                                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="status_kepemilikan"
                                       value="{{$data_perangkat->status_kepemilikan}}">
                                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ip_server"
                                       value="{{$data_perangkat->ip_server}}">
                                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status_server">
                                    ...
                                    <option
                                        value="Aktif" {{ $data_perangkat->status_server == 'Aktif' ? 'selected="selected"' : '' }}>
                                        Aktif
                                    </option>
                                    <option
                                        value="Tidak Aktif" {{ $data_perangkat->status_server == 'Tidak Aktif' ? 'selected="selected"' : '' }}>
                                        Tidak Aktif
                                    </option>
                                    <option
                                        value="Rusak" {{ $data_perangkat->status_server == 'Rusak' ? 'selected="selected"' : '' }}>
                                        Rusak
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_hdd">
                                    ...
                                    @foreach ($data_hdd as $hdd)
                                        <option
                                            value="{{ $hdd->id_hdd }}" {{ $data_perangkat->id_hdd == $hdd->id_hdd ? 'selected="selected"' : '' }}> {{ $hdd->ukuran_hdd }}
                                            ({{$hdd->keterangan}})
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_ram">
                                    ...
                                    @foreach ($data_ram as $ram)
                                        <option
                                            value="{{ $ram->id_ram }}" {{ $data_perangkat->id_ram == $ram->id_ram ? 'selected="selected"' : '' }}> {{ $ram->ukuran_ram }}
                                            (GB)
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_rak">
                                    ...
                                    @foreach ($data_rak as $rak)
                                        <option
                                            value="{{ $rak->id_rak }}" {{ $data_perangkat->id_rak == $rak->id_rak ? 'selected="selected"' : '' }}> {{ $rak->nomer_rak }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_core">
                                    ...
                                    @foreach ($data_core as $core)
                                        <option
                                            value="{{ $core->id_core }}" {{ $data_perangkat->id_core == $core->id_core ? 'selected="selected"' : '' }}> {{ $core->jumlah_core }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
