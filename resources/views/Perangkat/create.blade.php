                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_perangkat"
                                       value="{{old('nama_perangkat')}}" placeholder="Nama perangkat">
                                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tipe_perangkat" id="tipe_perangkat">
                                    <option value=" ">Pilih</option>
                                    <option value="1">RACK MOUNT</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ip_server" value="{{old('ip_server')}}"
                                       placeholder="Ip_Server">
                                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <select id="hdd" class="form-control" name="id_hdd">
                                    ...
                                    @foreach ($data_hdd as $hdd)
                                        <option
                                            value="{{ $hdd->id_hdd }}" {{ old('id_hdd') == $hdd->id_hdd ? 'selected="selected"' : '' }}> {{ $hdd->ukuran_hdd }}
                                            ({{$hdd->keterangan}})
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="ram" class="form-control" name="id_ram">
                                    ...
                                    @foreach ($data_ram as $ram)
                                        <option
                                            value="{{ $ram->id_ram }}" {{ old('id_ram') == $ram->id_ram ? 'selected="selected"' : '' }}> {{ $ram->ukuran_ram }}
                                            (GB)
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="rak" class="form-control" name="id_rak">
                                    ...
                                    @foreach ($data_rak as $rak)
                                        <option
                                            value="{{ $rak->id_rak }}" {{ old('id_rak') == $rak->id_rak ? 'selected="selected"' : '' }}> {{ $rak->nomer_rak }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <select id="core" class="form-control" name="id_core">
                                    ...
                                    @foreach ($data_core as $core)
                                        <option
                                            value="{{ $core->id_core }}" {{ old('id_core') == $core->id_core ? 'selected="selected"' : '' }}> {{ $core->jumlah_core }}</option>
                                    @endforeach
                                </select>
                                @if ($errors->any())
