            ...
            <div class="box-body form-inline ml-3">
                ...
                @foreach($tb_laporan_harian as $p)
                    <form action="{{ url('/laporan_hari/update') }}" method="post">
                        ...
                        Nama Tenaga<input type="text" required="required" name="nm_tenaga" value="{{ $p->nm_tenaga }}">
                        <br/>
                        Nama Divisi<input type="text" required="required" name="nama_divisi"
                                          value="{{ $p->nama_divisi }}"> <br/>
